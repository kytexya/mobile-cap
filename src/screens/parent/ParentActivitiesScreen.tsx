...
const ParentActivitiesScreen = () => {
  ...
  const loadActivities = async () => {
    try {
      ...
      if (!classId) {
        setActivities([]);
        setError('Không tìm thấy lớp liên kết cho học sinh này.');
        return;
      }
          ...
          return {
            ...
            images: Array.isArray(item.images)
              ...
              : Array.isArray(item.mediaFiles)
                ...
                : [],
            activityDate,
            teacherName: item.createdBy || item.teacherName || 'Giáo viên',
            className: item.className || 'Đang cập nhật',
          };
        })
        .sort(
      ...
      <Card.Content style={styles.cardContent}>
        ...
        {item.images.length > 0 ? (
          ...
          <View style={styles.emptyMedia}>
            ...
            <Text style={styles.emptyMediaText}>Chưa có hình ảnh</Text>
          </View>
        )}
      </Card.Content>
    </Card>
