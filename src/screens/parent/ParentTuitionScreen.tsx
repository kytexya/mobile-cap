...
interface ParentTuitionScreenProps {
  navigation?: any;
}

const ParentTuitionScreen: React.FC<ParentTuitionScreenProps> = ({ navigation }) => {
  ...
  const handlePay = (item: InvoiceItem) => {
  ...
  const onRefresh = useCallback(() => {
    setRefreshing(true);
    loadInvoices().then(() => setRefreshing(false));
  }, []);
