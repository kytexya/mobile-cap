...
import { ActivityIndicator, FlatList, Platform, Pressable, SafeAreaView, StyleSheet, View, useWindowDimensions } from 'react-native';
      ...
      {view === 'today' ? (
        <View style={[styles.quickActions, isLandscape && styles.quickActionsLandscape]}>
          <View style={styles.quickActionButton}>
            <Button
              mode="outlined"
              icon={() => <Filter size={14} color="#4F46E5" />}
                ...
                return (
                  <View key={`${item.id}-${student.id}`} style={styles.historyStudentRow}>
                    ...
                    <View style={styles.historyStudentMeta}>
                      ...
                      {canEdit ? (
                        <View style={[styles.historyStatusRow, isLandscape && styles.historyStatusRowLandscape]}>
                          <StatusPill
                            label="Present"
